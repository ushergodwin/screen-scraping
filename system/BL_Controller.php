...
class Password
{
     ...
     * @return string 64 bit character long encryped key
     */
    ...
    /**
     * @param string $key String to be encrypted
     * @return string 42 bit character long encryped key
     */
    ...
    /**
     * @param string $key String to be encrypted
     * @return string 32 bit character long encryped key
     */
...
class Session
{
     ...
     * @return bool True on success and Flase on faluire
     */
     ...
     * @return array|bool On successfull registeration of the session
     */
...
class Verify
{
    ...
    public function code() {
        $permited = "0127456789abcdefghijklmnopqrstuvwxyz";
        return sha1(substr(str_shuffle($permited), 0, 9));
    }
}
class Unique_Key
{
    ...
    /**
     * @param int $min The starting number when generating a radom number
